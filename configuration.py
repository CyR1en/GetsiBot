...
class ConfigNode(Enum):
    """
    Enumeration that contains data for all of the configuration options
    ...
    PREFIX = ("command_prefix", "('getsi', 'getsi, ')")
    WHINES = ("Whines", "['I hate it here.', 'Why does everyone hate me.']")
    CHANNELS = ("Channel ID", "[123232123, 123232321]")
